    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' https://js.stripe.com https://cdn.vercel-insights.com https://va.vercel-scripts.com https://js.hs-scripts.com https://js.hs-analytics.net https://js.hs-banner.com https://js.hubspot.com https://js.usemessages.com https://js.hsadspixel.net https://js.hscollectedforms.net https://challenges.cloudflare.com",
              "style-src 'self' 'unsafe-inline'",
              "img-src 'self' data: blob: https: https://track.hubspot.com https://*.hubspot.com https://forms.hsforms.com https://*.hs-banner.com",
              "font-src 'self' data:",
              "connect-src 'self' https://api.stripe.com https://vitals.vercel-insights.com https://api.hubapi.com https://forms.hubspot.com https://track.hubspot.com https://api.hubspot.com https://*.hubspot.com https://*.hs-analytics.net https://*.hscollectedforms.net https://js.hs-banner.com https://*.hs-banner.com https://forms.hsforms.com https://*.hubapi.com https://challenges.cloudflare.com",
              "frame-src https://js.stripe.com https://hooks.stripe.com https://app.hubspot.com https://forms.hsforms.com https://*.hubspot.com https://challenges.cloudflare.com",
