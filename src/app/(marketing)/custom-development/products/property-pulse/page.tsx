...
const breadcrumbSchema = {
  ...
  itemListElement: [
    { "@type": "ListItem", position: 1, name: "Home", item: `${SITE_URL}/` },
    {
      ...
      position: 2,
      name: "Products",
      item: `${SITE_URL}/custom-development/products`,
    },
    {
      "@type": "ListItem",
      position: 3,
      name: "Property Pulse",
      item: `${SITE_URL}/custom-development/products/property-pulse`,
    },
  ],
};

// Single one-time install fee. Mirrors the canonical pricing defined
// in src/app/(marketing)/custom-development/pricing/page.tsx. Keep in lockstep if the
...
const propertyPulseSchema = {
  ...
  url: `${SITE_URL}/custom-development/products/property-pulse`,
  publisher: {
    "@type": "Organization",
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/custom-development/products/property-pulse" },
  openGraph: {
    title: "Property Pulse for HubSpot CRM",
    description:
      "Property Pulse is a HubSpot marketplace app that surfaces every tracked property's full change history on one CRM card, filterable and exportable to CSV.",
    url: "/custom-development/products/property-pulse",
    type: "website",
    images: [
      {
        url: "/opengraph-image",
      ...
      */}
      ...
      <Container size="xl" className="pt-6">
        <Breadcrumbs
          items={[
            { label: "Home", href: "/" },
            { label: "Products", href: "/custom-development/products" },
