...
const webPageSchema = {
  ...
  url: `${SITE_URL}/custom-development/products/debrief/roadmap`,
  isPartOf: {
    "@type": "WebSite",
    "@id": `${SITE_URL}/#website`,
  },
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/custom-development/products/debrief/roadmap" },
  openGraph: {
    title: "Debrief roadmap · Dunamis Studios",
    description:
      "What's shipped, what's in progress, and what's next for Debrief.",
    url: "/custom-development/products/debrief/roadmap",
    type: "website",
    images: [
      {
        url: "/opengraph-image",
