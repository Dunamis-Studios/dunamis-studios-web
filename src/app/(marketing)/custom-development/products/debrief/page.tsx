...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 3,
      name: "Debrief",
      item: `${SITE_URL}/custom-development/products/debrief`,
    },
  ],
};
...
const debriefSchema = {
  ...
  url: `${SITE_URL}/custom-development/products/debrief`,
  publisher: {
    "@type": "Organization",
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/custom-development/products/debrief" },
  openGraph: {
    title: "Debrief: AI-powered CRM handoffs for HubSpot",
    description:
      "Debrief generates structured handoff briefs and draft messages from a HubSpot CRM card. User-initiated, not auto-triggered. Not a meeting tool.",
    url: "/custom-development/products/debrief",
    type: "website",
    images: [
      {
        url: "/opengraph-image",
      ...
      */}
      ...
      <div className="border-t border-[var(--border)] bg-[var(--bg-subtle)]">
        <Container size="md" className="py-8 text-center">
          ...
          <Link
            href="/custom-development/products/debrief/roadmap"
