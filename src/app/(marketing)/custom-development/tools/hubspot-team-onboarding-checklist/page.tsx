...
const faqPageSchema = buildFaqPageSchema(FAQ, {
  name: "HubSpot Team Onboarding Checklist FAQ",
  description:
    "Frequently asked questions about the Dunamis Studios HubSpot Team Member Onboarding Checklist: scoring phases, role-specific risk flags, and reuse.",
  url: `${SITE_URL}/custom-development/tools/hubspot-team-onboarding-checklist`,
});
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/custom-development/tools/hubspot-team-onboarding-checklist" },
  openGraph: {
    title: `${TITLE} · Dunamis Studios`,
    description: DESCRIPTION,
    url: "/custom-development/tools/hubspot-team-onboarding-checklist",
    type: "website",
    images: [
      {
        url: "/opengraph-image",
