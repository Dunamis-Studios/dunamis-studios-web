...
const faqPageSchema = buildFaqPageSchema(FAQ, {
  name: "Handoff Time Calculator FAQ",
  description:
    "Frequently asked questions about the Dunamis Studios Handoff Time Calculator: what it estimates, what inputs it takes, and how the data is handled.",
  url: `${SITE_URL}/custom-development/tools/handoff-time-calculator`,
});
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/custom-development/tools/handoff-time-calculator" },
  openGraph: {
    title: `${TITLE} · Dunamis Studios`,
    description: DESCRIPTION,
    url: "/custom-development/tools/handoff-time-calculator",
    type: "website",
    images: [
      {
        url: "/opengraph-image",
