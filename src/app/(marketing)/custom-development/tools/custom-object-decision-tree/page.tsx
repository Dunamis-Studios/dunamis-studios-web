...
const faqPageSchema = buildFaqPageSchema(FAQ, {
  ...
  url: `${SITE_URL}/custom-development/tools/custom-object-decision-tree`,
});
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/custom-development/tools/custom-object-decision-tree" },
  openGraph: {
    title: `${TITLE} · Dunamis Studios`,
    description: DESCRIPTION,
    url: "/custom-development/tools/custom-object-decision-tree",
    type: "website",
    images: [
      {
        url: "/opengraph-image",
