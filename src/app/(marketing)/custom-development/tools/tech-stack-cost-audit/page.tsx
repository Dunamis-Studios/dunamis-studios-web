...
const faqPageSchema = buildFaqPageSchema(FAQ, {
  name: "Tech Stack Cost Audit FAQ",
  description:
    "Frequently asked questions about the Dunamis Studios Tech Stack Cost Audit: outputs, granularity of inputs, source of the 46% non-utilization rate, and data handling.",
  url: `${SITE_URL}/custom-development/tools/tech-stack-cost-audit`,
});
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/custom-development/tools/tech-stack-cost-audit" },
  openGraph: {
    title: `${TITLE} · Dunamis Studios`,
    description: DESCRIPTION,
    url: "/custom-development/tools/tech-stack-cost-audit",
    type: "website",
    images: [
      {
        url: "/opengraph-image",
