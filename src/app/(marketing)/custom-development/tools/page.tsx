...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/custom-development/tools" },
  openGraph: {
    title: `${TITLE} · Dunamis Studios`,
    description: DESCRIPTION,
    url: "/custom-development/tools",
    type: "website",
    images: [
      {
        url: "/opengraph-image",
...
const TOOLS: ToolEntry[] = [
  {
    href: "/custom-development/tools/handoff-time-calculator",
  ...
  {
    href: "/custom-development/tools/property-audit-checklist",
  ...
  {
    href: "/custom-development/tools/hubspot-bloat-score",
  ...
  {
    href: "/custom-development/tools/lead-scoring-builder",
  ...
  {
    href: "/custom-development/tools/sales-cycle-stagnation-calculator",
  ...
  {
    href: "/custom-development/tools/tech-stack-cost-audit",
  ...
  {
    href: "/custom-development/tools/workflow-audit-checklist",
  ...
  {
    href: "/custom-development/tools/custom-object-decision-tree",
  ...
  {
    href: "/custom-development/tools/hubspot-team-onboarding-checklist",
...
const faqPageSchema = buildFaqPageSchema(FAQ, {
  ...
  url: `${SITE_URL}/custom-development/tools`,
});
