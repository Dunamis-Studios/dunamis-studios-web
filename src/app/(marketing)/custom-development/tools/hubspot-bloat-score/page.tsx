...
const faqPageSchema = buildFaqPageSchema(FAQ, {
  name: "HubSpot Bloat Score FAQ",
  description:
    "Frequently asked questions about the Dunamis Studios HubSpot Bloat Score: what bloat is, how it is measured, and where the per-tier limits come from.",
  url: `${SITE_URL}/custom-development/tools/hubspot-bloat-score`,
});
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/custom-development/tools/hubspot-bloat-score" },
  openGraph: {
    title: `${TITLE} · Dunamis Studios`,
    description: DESCRIPTION,
    url: "/custom-development/tools/hubspot-bloat-score",
    type: "website",
    images: [
      {
        url: "/opengraph-image",
