...
const faqPageSchema = buildFaqPageSchema(FAQ, {
  ...
  url: `${SITE_URL}/custom-development/tools/sales-cycle-stagnation-calculator`,
});
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/custom-development/tools/sales-cycle-stagnation-calculator" },
  openGraph: {
    title: `${TITLE} · Dunamis Studios`,
    description: DESCRIPTION,
    url: "/custom-development/tools/sales-cycle-stagnation-calculator",
    type: "website",
    images: [
      {
        url: "/opengraph-image",
