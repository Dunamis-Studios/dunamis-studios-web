...
const faqPageSchema = buildFaqPageSchema(FAQ, {
  name: "Lead Scoring Builder FAQ",
  description:
    "Frequently asked questions about the Dunamis Studios Lead Scoring Builder, including its outputs, tier-aware caps, and HubSpot tool compatibility.",
  url: `${SITE_URL}/custom-development/tools/lead-scoring-builder`,
});
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/custom-development/tools/lead-scoring-builder" },
  openGraph: {
    title: `${TITLE} · Dunamis Studios`,
    description: DESCRIPTION,
    url: "/custom-development/tools/lead-scoring-builder",
    type: "website",
    images: [
      {
        url: "/opengraph-image",
