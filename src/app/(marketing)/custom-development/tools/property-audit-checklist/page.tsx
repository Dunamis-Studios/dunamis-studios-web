...
const faqPageSchema = buildFaqPageSchema(FAQ, {
  ...
  url: `${SITE_URL}/custom-development/tools/property-audit-checklist`,
});
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/custom-development/tools/property-audit-checklist" },
  openGraph: {
    title: `${TITLE} · Dunamis Studios`,
    description: DESCRIPTION,
    url: "/custom-development/tools/property-audit-checklist",
    type: "website",
    images: [
      {
        url: "/opengraph-image",
