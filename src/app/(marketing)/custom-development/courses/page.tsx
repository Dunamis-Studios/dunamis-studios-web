...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/custom-development/courses" },
  openGraph: {
    title: `${TITLE} · Dunamis Studios`,
    description: DESCRIPTION,
    url: "/custom-development/courses",
    type: "website",
    images: [
      {
        url: "/opengraph-image",
...
const COURSES: CourseEntry[] = [
  {
    href: "/custom-development/courses/hubspot-audit",
...
function buildCollectionSchema() {
  return {
    ...
    name: TITLE,
    description: DESCRIPTION,
    url: `${SITE_URL}/custom-development/courses`,
    publisher: {
      "@type": "Organization",
