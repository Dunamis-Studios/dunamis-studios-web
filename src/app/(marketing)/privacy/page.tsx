        ...
        <div className="rounded-lg border border-[var(--fg-subtle)]/30 bg-[color-mix(in_oklch,var(--fg)_4%,transparent)] px-4 py-4 text-sm">
          ...
          <ul className="mt-3 list-disc space-y-1 pl-5">
            <li>
              ...
              &ldquo;business&rdquo; under CCPA/CPRA. Dunamis Studios is a{" "}
            ...
            <li>
              ...
              and the &ldquo;business&rdquo; under CCPA/CPRA. This policy
              governs that data.
            </li>
          </ul>
        </div>
        <p className="mt-4">
          References in this policy to &ldquo;Dunamis Studios,&rdquo;
          &ldquo;Dunamis,&rdquo; &ldquo;we,&rdquo; &ldquo;us,&rdquo; or
          &ldquo;our&rdquo; mean <strong>Joshua Robert Bradford</strong>, an
    ...
    body: (
      <>
        ...
        <p className="mt-3">
          ...
          is not a &ldquo;high-risk&rdquo; AI system under the EU AI Act.
        </p>
        <p className="mt-3">
