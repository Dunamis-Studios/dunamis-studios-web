...
const PATCHES: Patch[] = [
  ...
  // --- Property change apps article: link Bloat Score
  {
    ...
    toolUrl: "/custom-development/tools/hubspot-bloat-score",
    find: "If your real problem is \"our portal is a mess and I want to clean it up,\" any of these are worth a look.",
    replace:
      "If your real problem is \"our portal is a mess and I want to clean it up,\" any of these are worth a look. If you want a free triage pass first, the <a target=\"_blank\" rel=\"noopener noreferrer\" href=\"/custom-development/tools/hubspot-bloat-score\">Bloat Score</a> we publish runs the same shape of assessment in your browser.",
  },
  ...
  // --- Stale properties guide: link Bloat Score (intro)
  {
    ...
    replace:
      "Five years of this and a contact object can carry 600+ properties, of which maybe 80 are still actively maintained. If you have not benchmarked your portal against tier-typical counts before, the <a target=\"_blank\" rel=\"noopener noreferrer\" href=\"/custom-development/tools/hubspot-bloat-score\">Bloat Score</a> is a free read across properties, workflows, lists, and asset density per contact.",
  },
